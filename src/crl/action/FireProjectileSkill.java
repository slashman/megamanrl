...
public abstract class FireProjectileSkill extends HeartAction{
	...
	public void execute(){
        ...
        if (aPlayer.getLastFacing() == Player.FACING_RIGHT){
        	targetPosition = Position.add(performer.getPosition(), Action.VARRG);
        } else {
        	targetPosition = Position.add(performer.getPosition(), Action.VARLF);
        }
