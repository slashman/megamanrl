...
import crl.ui.consoleUI.effects.CharMegamanBlastEffect;
...
public class CharEffects {
	private CharEffect [] effects = new CharEffect[]{
		...
		new CharSplashEffect("SFX_BOMB","*~.", ConsoleSystemInterface.RED,50),
		...
		new CharMegamanBlastEffect("SFX_MEGAMAN_BLAST", "oO", ConsoleSystemInterface.BLUE, 40),
